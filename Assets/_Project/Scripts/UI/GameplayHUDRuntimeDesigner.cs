...
namespace GanhHangRong.UI
{
    public class GameplayHUDRuntimeDesigner : MonoBehaviour
    {
        ...
        private void UpdateRecipeContent()
        {
            ...
            recipeTitleText.text = "ĐƠN HÀNG: " + activeDrinkName;
        ...
        private string[] ParseIngredients(string recipeString)
        {
            ...
            if (firstLine.StartsWith("Công thức: "))
            {
                firstLine = firstLine.Substring("Công thức: ".Length);
            }
        ...
        private void PopulateIngredientRow(GameObject row, string ingredientText)
        {
            ...
            if (lowerText.Contains("ly") || lowerText.Contains("cốc")) spriteName = "ly";
            ...
            else if (lowerText.Contains("nước") || lowerText.Contains("sôi")) spriteName = "nuoc";
            else if (lowerText.Contains("đá") || lowerText.Contains("ice")) spriteName = "da";
